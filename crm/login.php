...
<body class="auth-page"><main class="auth-card">
  <div class="brand auth-brand"><span class="brand-mark">D</span><span>DISTILLOGIC<small>CRM workspace</small></span></div>
  <h1>Καλώς ήρθατε</h1><p>Συνδεθείτε για να διαχειριστείτε τις επαγγελματικές επικοινωνίες.</p>
